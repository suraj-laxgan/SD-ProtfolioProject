...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <form id="formAccountSettings" method="POST" action="{{ route('skill_category.update') }}">
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control @error('name') is-invalid @enderror" value="{{ $skillCategory->name }}"
