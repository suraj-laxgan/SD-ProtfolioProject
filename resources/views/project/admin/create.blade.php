...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    <form id="formAccountSettings" method="POST" action="{{ route('project.store') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input class="form-control @error('github_link') is-invalid @enderror"
                                    value="{{ old('github_link') }}" type="text" id="github_link" name="github_link"
                                    autofocus />
                            </div>
                            <div class="mb-3 col-md-6">
                                <label for="live_url" class="form-label">Live URL</label>
                                <input class="form-control @error('live_url') is-invalid @enderror"
                                    value="{{ old('live_url') }}" type="text" id="live_url" name="live_url" autofocus />
                            </div>
